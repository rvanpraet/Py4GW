...
class BloodBondUtility(CustomSkillUtilityBase):
    def __init__(self,
        ...
        score_definition: ScorePerAgentQuantityDefinition = ScorePerAgentQuantityDefinition(lambda enemy_qte: 25 if enemy_qte >= 2 else 0),
